...
-- ============================================
-- 1. SECURE THE PUBLIC VIEW (Fixed)
-- ============================================
...
COMMENT ON VIEW public.talent_profiles_public IS 'Safe public view for talent discovery - excludes all sensitive data like Stripe IDs, subscription info, etc. Accessible to public for discovery.';
