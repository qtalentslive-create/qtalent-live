  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-white/30 text-white hover:bg-white/40 focus:bg-white/40",
        day_today: "border border-white/40 font-medium",
        day_outside:
          "day-outside text-muted-foreground opacity-50 aria-selected:bg-white/20 aria-selected:text-muted-foreground aria-selected:opacity-30",
